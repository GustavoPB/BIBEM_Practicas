...
%%% DELETED - INCLUDE IF IT'S NECESSARY
	...
	\include{./chapters/2_problem_design}
	\include{./chapters/3_NSGA_ii_algorithm}
	\include{./chapters/3.1_outline_ga}
	\include{./chapters/3.2_search_components}
	\include{./chapters/3.2.1_dominance_based_ranking}
	\include{./chapters/3.2.2_crowding_distance}
	\include{./chapters/3.2.3_elitism}
	\include{./chapters/3.3_outline_nsga_ii}
	\include{./chapters/3.4_codification}
	\include{./chapters/3.5_operators}
	\include{./chapters/3.5.1_crossover}
	\include{./chapters/3.5.2_mutation}
	\include{./chapters/4_implementation}
	\include{./chapters/4.1_moea_frame}
	\include{./chapters/4.2_performance}
	\include{./chapters/5_conclusion}
	\include{./chapters/6_Biblio}
